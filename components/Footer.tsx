...
const Footer: React.FC = () => (
  <footer className="bg-black text-white py-8 mt-10">
    <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div>
        <div className="mb-2">US Toll Free: (877) 982-7774</div>
        <div className="mb-2">Fax: 713-234-5771</div>
        <div className="mb-2">Email: <a href="mailto:sales@usedautoparts.pro" className="underline">sales@usedautoparts.pro</a></div>
